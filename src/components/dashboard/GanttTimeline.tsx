...
const GanttRow = React.memo(function GanttRow({
  ...
  return (
    <div ref={rowRef} className="relative z-0 flex border-b border-border hover:bg-bg-secondary/20 transition-colors group group/bar">
      {/* Sidebar */}
      <div
        ...
        <div className="flex items-center gap-2 min-w-0">
          ...
          {!isSidebarCollapsed && (
            <>
              ...
              >
                {level > 0 && (
                  <div style={{ width: level * indentStepPx }} className="flex-shrink-0" />
                )}
                {hasChildren && (
                  <button
    ...
    for (const n of nodes) {
      ...
      items.push(
        <GanttRow
          ...
          rowRef={(el) => treeRegisterRow(n.id, el)}
        />,
      );
                ...
                return (
                  <div key={group.id}>
                    ...
                    {!collapsed && (
                      <>
                        <div
                          ref={(el) => treeRegisterGroupHost(group.id, el)}
